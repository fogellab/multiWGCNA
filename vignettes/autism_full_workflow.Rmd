...
# Step 1: Read in microarray data from human post-mortem brains.

Data from Voineagu et al. 2011 (https://www.nature.com/articles/nature10110) has two sample traits: 1) autism versus control, and 2) temporal cortex versus frontal cortex. Since this is purely an example of how to run the entire analysis from start to finish, we are going to limit our analysis to 500 randomly selected probes. Let's also set some useful global variables, like the alpha level of significance and the soft thresholding power for our network.   
...
# Step 2: Perform network construction, module eigengene calculation, module-trait correlation. 
...
We'll save the results in a list. Then, let's take a look at the mutual best matches between autism modules and control modules. 
...
# Step 5: Perform the module preservation analysis. 
...
# Step 6: Summarize interesting results from the analyses.
