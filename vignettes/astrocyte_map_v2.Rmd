...
Since module preservation scores are dependent on the module size (larger modules have larger preservation scores), we generate the null distribution of preservation scores based on similarly sized modules from each permutation. 

```{r, eval = FALSE}
# Extract the preservation score distribution
results$scores.summary = PreservationScoreDistribution(results$permutation.test, 
                                                       moduleOfInterestSize = 300 # The size of the module of interest (dM15)
                                                       )
