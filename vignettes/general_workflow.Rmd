...
Step 1: Read in autism microarray data from Voineagu et al. 2011. For the sake of time, we are going to limit our analysis to 2000 randomly selected probes. Let's also set some useful global variables, like the alpha level of significance and the soft thresholding power for our network construction. 
